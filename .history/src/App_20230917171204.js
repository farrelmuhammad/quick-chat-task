...
function App() {
  ...
  return (
    <div>
      ...
      {/* Quick Start button */}
      <button className="quick-start-button p-4 rounded-full" onClick={toggleAdditionalButtons}>
      ...
      {showAdditionalButtons && (
        <div className="additional-buttons">
          ...
          <button className="quick-start-button">Button 1</button>
          <button className="quick-start-button">Button 2</button>
        </div>
      )}
    </div>
  );
