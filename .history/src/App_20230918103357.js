...
function App() {
  ...
  return (
    <div>
      ...
      {/* Quick Start button */}
      <button className="fixed bottom-10 right-10 bg-blue-500 text-white cursor-pointer transition hover:bg-blue-700 p-4 rounded-full" onClick={toggleAdditionalButtons}>
