  ...
  return (
    <div>
      ...
      {showAdditionalButtons && (
        <div className="fixed bottom-6 right-20 space-x-2 flex flex-col items-center">
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm mt-2">Button 1</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm mt-2">Button 2</p>
          </div>
        </div>
