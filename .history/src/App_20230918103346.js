...
function App() {
  ...
  return (
    <div>
      ...
      {/* Quick Start button */}
      <button className="fixed bottom-2 right-2 bg-blue-500 text-white cursor-pointer transition hover:bg-blue-700 p-4 rounded-full" onClick={toggleAdditionalButtons}>
