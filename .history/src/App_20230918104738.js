  ...
  return (
    <div>
      ...
      {showAdditionalButtons && (
        <div className="fixed bottom-6 right-20 space-x-2 text-center">
          <button className="bg-gray-200 text-white cursor-pointer transition hover:bg-gray-300 p-3.5 rounded-full">
