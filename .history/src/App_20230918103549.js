      ...
      <div className="flex">
        {showAdditionalButtons && (
          <div className="additional-button">
            <button className="bg-blue-500 text-white cursor-pointer transition hover:bg-blue-700 p-4 rounded-full">
              Button 1
            </button>
            <button className="bg-blue-500 text-white cursor-pointer transition hover:bg-blue-700 p-4 rounded-full">
              Button 2
        ...
        <button
          className={`fixed bottom-6 right-6 bg-blue-500 text-white cursor-pointer transition hover:bg-blue-700 p-4 rounded-full ${showAdditionalButtons ? 'w-16' : 'w-16 h-16'
            }`}
